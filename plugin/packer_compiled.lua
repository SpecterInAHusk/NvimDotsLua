...
vim.cmd [[au FileType tex ++once lua require("packer.load")({'ale', 'vim-latex-live-preview', 'vimtex'}, { ft = "tex" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'auto-pairs', 'coc.nvim', 'vim-signify', 'vim-surround', 'friendly-snippets', 'vim-snippets', 'rainbow', 'vim-startuptime', 'ultisnips'}, { event = "VimEnter *" }, _G.packer_plugins)]]
