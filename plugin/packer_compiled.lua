...
_G.packer_plugins = {
  ...
  ["tabline.nvim"] = {
    config = { "\27LJ\2\n�\3\0\0\5\0\r\0\0176\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\5\0005\4\4\0=\4\6\0035\4\a\0=\4\b\3=\3\t\2B\0\2\0016\0\n\0009\0\v\0'\2\f\0B\0\2\1K\0\1\0�\1      set guioptions-=e \" Use showtabline in gui vim\n      set sessionoptions+=tabpages,globals \" store tabpages and globals in session\n    \bcmd\bvim\foptions\25component_separators\1\3\0\0\b\b\23section_separators\1\0\b\19show_tabs_only\2\20modified_italic\1\18modified_icon\a+ \23show_filename_only\1\15show_bufnr\1\18show_devicons\2\21show_tabs_always\1\27max_bufferline_percent\3B\1\3\0\0\b\b\1\0\1\venable\2\nsetup\ftabline\frequire\0" },
    loaded = true,
...
vim.cmd [[au FileType xml ++once lua require("packer.load")({'emmet-vim', 'ale'}, { ft = "xml" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType html ++once lua require("packer.load")({'emmet-vim', 'ale'}, { ft = "html" }, _G.packer_plugins)]]
vim.cmd [[au FileType tex ++once lua require("packer.load")({'vim-latex-live-preview', 'vimtex', 'ale'}, { ft = "tex" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'ultisnips', 'auto-pairs', 'coc.nvim', 'vim-signify', 'friendly-snippets', 'vim-snippets', 'rainbow', 'vim-startuptime'}, { event = "VimEnter *" }, _G.packer_plugins)]]
