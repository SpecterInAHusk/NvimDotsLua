...
vim.cmd [[au FileType tex ++once lua require("packer.load")({'vim-latex-live-preview', 'ale', 'vimtex'}, { ft = "tex" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'auto-pairs', 'coc.nvim', 'vim-sneak', 'vim-startuptime', 'vim-snippets', 'vim-surround', 'rainbow', 'friendly-snippets', 'vim-signify', 'ultisnips'}, { event = "VimEnter *" }, _G.packer_plugins)]]
