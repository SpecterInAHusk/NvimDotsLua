...
_G.packer_plugins = {
  ...
  ["nvim-tree.lua"] = {
    ...
    config = { "\27LJ\2\n5\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\26settings.nvimtree.lua\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/fjs/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
  ...
  ["vim-surround"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/fjs/.local/share/nvim/site/pack/packer/opt/vim-surround",
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-snippets', 'vim-startuptime', 'friendly-snippets', 'vim-surround', 'rainbow', 'coc.nvim', 'vim-signify', 'auto-pairs', 'ultisnips', 'vim-sneak'}, { event = "VimEnter *" }, _G.packer_plugins)]]
